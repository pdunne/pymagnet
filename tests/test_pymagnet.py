...
# FIXME: Update all tests for new API
...
class MagnetTest(unittest.TestCase):
    ...
    def test_create_cylinder(self):
        ...
        center = (0.0, 0.0, 0.0)
        self.assertEqual(
            pm.magnets.Cylinder(R, L, Jr, center=center).mag_type, "Cylinder"
        )
    ...
    def test_create_prism(self):
        ...
        center = (0.0, 0.0, 0.0)
        self.assertEqual(pm.magnets.Prism(a, b, c, Jr, center=center).mag_type, "Prism")

    def test_create_cube(self):
        """Creating a cube magnet"""
        a, Jr = 1.0, 1.0
        center = (0.0, 0.0, 0.0)
        self.assertEqual(pm.magnets.Cube(a, Jr, center=center).mag_type, "Cube")
    ...
    def test_create_rectangle(self):
        ...
        center = (0.0, 0.0)
        self.assertEqual(
            pm.magnets.Rectangle(a, b, Jr, center=center).mag_type, "Rectangle"
        )
    ...
    def test_create_square(self):
        ...
        center = (0.0, 0.0)
        self.assertEqual(pm.magnets.Square(a, Jr, center=center).mag_type, "Square")
    ...
    def test_1D_cylinder_surface_max(self):
        ...
        Jr = 1.0
        zc = -L / 2
        m_cyl = pm.magnets.Cylinder(radius=R, length=L, Jr=Jr, center=(0.0, 0.0, zc))
    ...
    def test_3D_four_cubes(self):
        ...
        _ = pm.magnets.Cube(a=a, Jr=1.0, center=(a + hGap, 0, a), theta=theta, phi=phi)
    ...
    def test_solenoid_off_axis(self):
        ...
        R = 5e-3
        L = 20e-3
        m_cyl = pm.magnets.Cylinder(radius=R, length=L, Jr=1.0, center=(0.0, 0.0, 0))

        result = round(
            np.linalg.norm(m_cyl._calcB_cyl(m_cyl.radius * 0.4, m_cyl.length * 0.2)), 5
        )
